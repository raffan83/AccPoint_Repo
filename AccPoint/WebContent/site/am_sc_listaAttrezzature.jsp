...
<th>Azioni</th>
 ...
 <c:forEach items="${lista_attrezzature}" var="attrezzatura" varStatus="loop">
	...
	<td>${attrezzatura.matricola }</td>
	<td>${attrezzatura.tipo }</td>
	<td>${attrezzatura.volume }</td>
	<td>${attrezzatura.sondaVelocita }</td>
	<td>${attrezzatura.pressione }</td>
	<td>${attrezzatura.costruttore }</td>
	<td>${attrezzatura.nFabbrica }</td>

	<td><fmt:formatDate pattern = "dd/MM/yyyy" value = "${attrezzatura.dataVerifica }" /></td>
	<td><fmt:formatDate pattern = "dd/MM/yyyy" value = "${attrezzatura.dataProssimaVerifica }" /></td>
	<td>${attrezzatura.frequenza }</td>
	<td>${attrezzatura.anno }</td>
...
<%-- <a class="btn btn-warning" title="Click per modificare l'intervento" onClick="modificaStrumento('${attrezzatura.id}','${utl:escapeJS(attrezzatura.descrizione)}','${utl:escapeJS(attrezzatura.matricola)}','${utl:escapeJS(attrezzatura.tipo)}','${utl:escapeJS(attrezzatura.volume)}','${utl:escapeJS(attrezzatura.pressione)}','${utl:escapeJS(attrezzatura.costruttore)}','${utl:escapeJS(attrezzatura.nFabbrica)}','<fmt:formatDate pattern="dd/MM/yyyy" value="${attrezzatura.dataVerifica}" />','<fmt:formatDate pattern="dd/MM/yyyy" value="${attrezzatura.dataProssimaVerifica}" />','${utl:escapeJS(attrezzatura.frequenza)}','${utl:escapeJS(attrezzatura.anno)}','${attrezzatura.id_cliente}','${attrezzatura.id_sede}',${utl:escapeJS(utl:toJson(attrezzatura)) })"><i class="fa fa-edit"></i></a> --%>

 <a class="btn btn-warning" title="Click per modificare l'intervento" onClick="modificaStrumento(${utl:escapeJS(utl:toJson(attrezzatura)) })"><i class="fa fa-edit"></i></a>
 <a href="#" class="btn btn-primary customTooltip" title="Click per clonare oggetto in prova" onClick="clona('${attrezzatura.id}')"><i class="fa fa-clone"></i></a>
<a href="#" class="btn btn-primary customTooltip customLink" title="Click per visualizzare gli allegati" onclick="modalAllegati('${attrezzatura.id }')"><i class="fa fa-archive"></i></a>	
	</td>
	</tr>
	</c:forEach> 
...
<script type="text/javascript">
	...
	function modificaStrumento(attrezzatura) { 

		$('#id_attrezzatura').val(attrezzatura.id);
		

		  $('#descrizione_mod').val(attrezzatura.descrizione);
		    $('#matricola_mod').val(attrezzatura.matricola);
		    $('#tipo_mod').val(attrezzatura.tipo);
		    $('#volume_mod').val(attrezzatura.volume);

		    $('#pressione_mod').val(attrezzatura.pressione);
		    $('#costruttore_mod').val(attrezzatura.costruttore);
		    $('#numero_fabbrica_mod').val(attrezzatura.nFabbrica);

		    $('#data_verifica_mod').val(attrezzatura.dataVerifica);
		    $('#data_prossima_verifica_mod').val(attrezzatura.dataProssimaVerifica);
		    $('#frequenza_mod').val(attrezzatura.frequenza);
		    $('#anno_mod').val(attrezzatura.anno);
		    $('#sonda_velocita_mod').val(attrezzatura.sondaVelocita);

		    
		    $('#cliente_general_mod').val(attrezzatura.id_cliente);
		    $('#cliente_general_mod').change()
		    
		    if(attrezzatura.id_sede!=0){
		    	$('#sede_general_mod').val(attrezzatura.id_sede+"_"+attrezzatura.id_cliente);
		    }else{
		    	$('#sede_general_mod').val(attrezzatura.id_sede);
		    }
		    
		    $('#numero_porzioni_mod').val(attrezzatura.numero_porzioni);
		    $('#label_img_mod').html(attrezzatura.filename_img)
		    ...
		    var lista_zone = attrezzatura.listaZoneRiferimento.sort(function(a, b) {
		    	  return a.id - b.id;
		    });
...
function clona(id_attrezzatura)
{
	dataObj={};
...
function modalAllegati(id_attrezzatura){
   ...
   var dataString ="action=allegati&id_attrezzatura="+ id_attrezzatura;
