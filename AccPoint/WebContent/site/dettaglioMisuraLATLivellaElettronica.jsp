...
<div class="box-body">
        ...
        <ul class="list-group list-group-unbordered">
                ...
                <div class="col-md-2">
                  ...
                  <div class="col-md-10">
                   <a href="#" onClick="dettaglioStrumentoFromMisura('${misura.strumento.__id}')" class="pull-right customTooltip" title="Click per aprire il dettaglio dello stumento" ><c:out value="${misura.strumento.denominazione} (${misura.strumento.matricola} | ${misura.strumento.codice_interno})"></c:out></a>
                  </div>
                  </div>
                </li>
                <li class="list-group-item">
