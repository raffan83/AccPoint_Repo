...
<th>Stato</th>
<th>Email</th>
<c:if test="${id_azienda eq 0 and 
              (userObj.checkRuolo('AM') or userObj.checkRuolo('F1'))}">
    <th>Disabilitato</th>
</c:if>
<c:if test="${userObj.checkRuolo('AM') || userObj.checkRuolo('F1')  }"> 
<th>Inserito da</th>
...
<c:if test="${(id_azienda eq 0) and (userObj.checkRuolo('AM') or userObj.checkRuolo('F1'))}">
    <td>
        <c:if test="${partecipante.disabilitato eq 0}">
            NO
        </c:if>
        <c:if test="${partecipante.disabilitato eq 1}">
            SI
        </c:if>
    </td>
</c:if>
