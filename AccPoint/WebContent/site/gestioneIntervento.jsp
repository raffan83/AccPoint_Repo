  ...
  <div id="corpoframe" class="content-wrapper">
   <!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <c:if test="${userObj.checkPermesso('NUOVO_INTERVENTO_METROLOGIA') && commessa.SYS_STATO!='1CHIUSA'}">  <button class="btn btn-default pull-right" onClick="nuovoInterventoFromModal()" style="margin-right:5px"><i class="glyphicon glyphicon-edit"></i> Nuovo Intervento</button></c:if>
    </section>
