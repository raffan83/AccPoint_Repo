                ...
                <div class="row">
	                ...
	                <div class="col-xs-10">
	                  ...
	                  <div class="col-xs-2 pull-right"> 	           
	                    ...
	                    <a class="btn btn-danger btn-xs pull-right" onClick="eliminaAllegatoAttrezzatura('${allegato.id  }')"><i class="fa fa-trash"></i></a>
	                  <a class="btn btn-danger btn-xs  pull-right"style="margin-right:5px" href="gestioneControlliOperativi.do?action=download_allegato&id_allegato=${allegato.id }&id_attrezzatura=${allegato.id_attrezzatura}"><i class="fa fa-arrow-down small"></i></a>
	                  </div>
                  </div>
                </li>
                </c:forEach>
    ...
    <div class="modal-content">
     <div class="modal-header">
      ...
      <input type="hidden" id="elimina_id_strumento">
	               ...
	               <a class="btn btn-primary" onclick="eliminaAllegatoAttrezzatura($('#elimina_allegato_id').val())" >SI</a>
...
function eliminaAllegatoAttrezzatura(id_allegato){
...
$('#fileupload').fileupload({
	 url: "gestioneControlliOperativi.do?action=upload_allegati&id_attrezzatura=${id_attrezzatura}"	,
	 dataType: 'json',	 
	  ...
	  add: function(e, data) {
	 	...
	 	if(data.result.success){
			...
			$('#myModalError').on("hidden.bs.modal",function(){
				...
				exploreModal("gestioneControlliOperativi.do","action=lista_allegati&id_attrezzatura=${id_attrezzatura}","#content_allegati");
...
function eliminaAllegatoAttrezzatura(id_allegato ){
	...
	callAjax(dataObj, "gestioneControlliOperativi.do?action=elimina_allegato", function(data, textStatus){
