                ...
                <div class="row">
	                ...
	                <div class="col-xs-10">
	                  ...
	                  <div class="col-xs-2 pull-right"> 	           
	                    ...
	                    <a class="btn btn-danger btn-xs pull-right" onClick="modalEliminaAllegatoDpi('${allegato.id  }')"><i class="fa fa-trash"></i></a>
	                  <a class="btn btn-danger btn-xs  pull-right"style="margin-right:5px" href="gestioneDpi.do?action=download_allegato&id_allegato=${allegato.id }&id_manuale=${allegato.id_manuale}"><i class="fa fa-arrow-down small"></i></a>
	                  </div>
                  </div>
                </li>
                </c:forEach>
    ...
    <div class="modal-content">
     <div class="modal-header">
      ...
      <input type="hidden" id="elimina_id_strumento">
	               ...
	               <a class="btn btn-primary" onclick="eliminaAllegatoDpi($('#elimina_allegato_id').val())" >SI</a>
...
function modalEliminaAllegatoDpi(id_allegato){
...
function eliminaAllegatoDpi(id_allegato ){
	
	dataObj = {};
	dataObj.id_allegato = id_allegato;

	callAjax(dataObj, "gestioneDpi.do?action=elimina_allegato", function(data, textStatus){
