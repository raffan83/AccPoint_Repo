...
<div class="row">
<div class="col-lg-12">
<button class="btn btn-primary" onClick="nuovoInterventoFromModal('#modalNuovoUtente')">Nuovo Cliente</button><div id="errorMsg" ></div>
</div>
</div>
 ...
 <c:forEach items="${listaUtenti}" var="utente" varStatus="loop">
	...
	<td>
	 <c:forEach items="${listaClienti}" var="cliente">
	 	<c:if test="${utente.idCliente == cliente.__id}">
	...
	<td>
		<c:forEach items="${listaSedi}" var="sedi">
	 	<c:if test="${utente.idSede == sedi.__id}">
			${sedi.descrizione} - ${sedi.indirizzo} 
		</c:if>
	 </c:forEach>
	</td>
	<td>
     ...
     <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="col-sm-10">
                      ...
                      <select id="company" data-placeholder="Seleziona Cliente..."  class="form-control select2" aria-hidden="true" data-live-search="true" name="company" required>
        ...
        <div class="col-sm-10">
					   ...
					   <select class="form-control required" id="sede" name="sede" data-placeholder="Seleziona Sede"  disabled class="form-control select2" aria-hidden="true" data-live-search="true" required>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        ...
        <div class="col-sm-10">
                      ...
                      <select id="companymod" data-placeholder="Seleziona Cliente..."  class="form-control select2" aria-hidden="true" data-live-search="true" name="company" required>
	                    <option value="">Seleziona una Company</option>
	                      <c:forEach items="${listaClienti}" var="cliente">
	                           <option value="${cliente.__id}">${cliente.nome}</option> 
	                     </c:forEach>
        ...
        <div class="col-sm-10">
					   ...
					   <select class="form-control required" id="sedemod" name="sede" data-placeholder="Seleziona Sede"  disabled class="form-control select2" aria-hidden="true" data-live-search="true" required>
                       					<option value="">Seleziona Sede</option>
                                            <c:forEach items="${listaSedi}" var="sedi" varStatus="loop">
...
<script type="text/javascript">
  ...
  table.columns().eq( 0 ).each( function ( colIdx ) {
	...
	$("#companymod").change(function() {
	    
	  	  if ($(this).data('options') == undefined) 
	  	  {
	  	    $(this).data('options', $('#sedemod option').clone());
	  	  }
	  	 ...
	  	 $("#sedemod").prop("disabled", false);
	  	 
	  	  $('#sedemod').html(opt);
	  	  
	  	  $("#sedemod").trigger("chosen:updated");
