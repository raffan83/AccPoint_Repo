...
function cercaAssegnazioni(){
	...
	if(startDatePicker!= '' && endDatePicker!=''){
		...
		dataString = "action=cerca_controllo&dateFrom=" + formatDate(startDatePicker) + "&dateTo=" + formatDate(endDatePicker)+"&utente="+utente;	
	}else{
		dataString = "action=cerca_controllo&utente="+utente;
