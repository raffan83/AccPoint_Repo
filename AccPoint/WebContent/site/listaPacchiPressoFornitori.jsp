						  ...
						  <c:forEach items="${lista_pacchi_grafico}" var="origine" varStatus="loop">
                           ...
                           <c:if test="${splitted[9] == '0'}">
                            <tr style="position:relative">
                               ...
                               <td  id="${splitted[0]}_11" style="position:relative">${splitted[10]}</td>
...
callAjax(dataObj, "gestionePacco.do?action=update_dashboard_for", function(datab, status){
