...
public class ArubaSignService {
	...
	public static void testSRV(String utente) {
		...
		File f = new File("C:\\\\Users\\\\raffaele.fantini\\\\Desktop\\\\FirmDigitale\\\\Test\\\\scaricaCertificato.pdf");
		URI uri = f.toURI();
...
//	System.out.println("Status :"+response.getPkcs7SignV2Response().get_return().getReturn_code());
	...
	DataHandler fileReturn=response.getPkcs7SignV2Response().get_return().getBinaryoutput();
	 ...
	 File targetFile = new File("C:\\Users\\raffaele.fantini\\Desktop\\FirmDigitale\\Test\\scaricaCertificato_1.pdf.p7m");
