...
public class CostantiCertificato {
	public static final String FOOTER_LEFT="MOD-LAB-003";
	public static final String FOOTER_RIGHT="Rev. A del 01/06/2011";
	...
	public static final String DESCRIZIONE_INCERTEZZA = "L'incertezze di misura dichiarate in questo documento sono espresse come due volte lo scarto tipo (corrispondente, nel caso di distribuzione normale, ad un livellodi confidenza di circa 95%)";
