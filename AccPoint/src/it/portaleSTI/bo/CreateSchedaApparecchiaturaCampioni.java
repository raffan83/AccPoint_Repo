...
public class CreateSchedaApparecchiaturaCampioni {
	...
	public CreateSchedaApparecchiaturaCampioni(CampioneDTO campione, Session session) throws Exception {
		
		
		 build(campione, session);
	}
	
	
	private void build(CampioneDTO campione, Session session) throws Exception {

		InputStream is =  PivotTemplate.class.getResourceAsStream("scheda_anagrafica_campione.jrxml");
