...
public class CreateSchedaScadenzarioCampioni {
	...
	private void build(ArrayList<CampioneDTO> campioni, ArrayList<Integer> descrizioni,ArrayList<String> date, String data_start, String data_end) throws Exception {
		...
		InputStream is = PivotTemplate.class.getResourceAsStream("scadenzario_campioni.jrxml");		 
		...
		try {
			...
			File folder = new File(Costanti.PATH_FOLDER+"//ScadenzarioCampioni//");
			if(!folder.exists()) {
				folder.mkdirs();
			}
				
			  java.io.File file = new java.io.File(Costanti.PATH_FOLDER+"//ScadenzarioCampioni//SchedaListacampioni.pdf");
