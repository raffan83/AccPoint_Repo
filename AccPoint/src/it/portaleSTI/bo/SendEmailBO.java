...
public class SendEmailBO {
	...
	private static HtmlEmail getHtmlEmailVianovaCresco() throws EmailException {
	...
	private static HtmlEmail getHtmlEmailVianovaDelivery() throws EmailException {
	...
	private static Properties getPropertiesAruba() {
	...
	public static void sendEmailCertificatoVerificazione(VerCertificatoDTO certificato, String mailTo, ServletContext ctx) throws Exception {
		...
		Properties properties = getPropertiesAruba();
	...
	public static void sendEmailPianificazione(ForPiaPianificazioneDTO pianificazione, CommessaDTO commessa, ServletContext ctx) throws EmailException, MessagingException, IOException, ParseException {
		...
		Properties props = getPropertiesAruba();
	...
	public static void sendEmailClienteDocumentalWeb(File schedaConsegna, String mailTo,ServletContext ctx,SessioneDTO sessione) throws EmailException {
		...
		try {
			...
			// Create the email message
			HtmlEmail email = getHtmlEmailVianovaDelivery();
	...
	/*	ForCorsoDTO corso = GestioneFormazioneBO.getCorsoFromId(338, session);
		...
		*/
		...
		VerCertificatoDTO cert =GestioneVerCertificatoBO.getCertificatoById(993, session);
		sendEmailCertificatoVerificazione(cert, "raffan83@gmail.com", null);
